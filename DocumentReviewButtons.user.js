...
//Changelog
//24.08.23.2 - fixed echart button
...
document.addEventListener('keydown', function(theEvent) {
  ...
  closeButton = $('input[type="button"][value*="Close"]')
    ...
    case theAltKey && theKey==='q': //back page
 			var button = document.querySelector('[id*="prevP"]')

      //check if button is visible
			var visible = true
     	var styleVal = button.style.csstext
      if (styleVal != null){
      	if (styleVal.includes("hidden") == false ){
        visible = false
        } else{
        visible = true
        }
    ...
    case theAltKey && theKey==='w': //fwd page
      ...
      var button = document.querySelector('[id*="nextP"]')
      console.log(button)
			//check if button is visible
			var visible = true
    ...
    case theAltKey && theKey==='e': //last page
 			var button = document.querySelector('[id*="lastP"]')
...
33
  ...
  if (echartButton == null){
    echartButton = document.querySelector('[onclick*=SearchPatient]')
  }
